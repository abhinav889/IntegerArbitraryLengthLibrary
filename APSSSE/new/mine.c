...
int main(int argc, char const *argv[]) {
	...
	strcpy(a[9], "3");
	strcpy(a[10], "");
	strcpy(a[11], "");
	char *result1;
	/*int index1;

	result1 = intal_add(a[4], a[2]);
	if(!result1) {
	...
	result1 = intal_multiply(a[10], a[11]);
	if(!result1) {
